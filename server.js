...
// Middlewares y directorios estáticos
app.use(cors());
...
// Configuración de servidor HTTP con timeouts para prevenir 502s
const port = parseInt(process.env.PORT, 10) || 10000;
const host = "0.0.0.0";
const server = http.createServer(app);

server.keepAliveTimeout = 65000;       // >= ELB default 60 s :contentReference[oaicite:1]{index=1}
server.headersTimeout = 70000;         // debe ser > keepAliveTimeout :contentReference[oaicite:2]{index=2}
